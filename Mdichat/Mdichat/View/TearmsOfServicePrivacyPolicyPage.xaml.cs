...
namespace MdiChat.View
{
    ...
    public partial class TearmsOfServicePrivacyPolicyPage : ContentPage
    {
        public TearmsOfServicePrivacyPolicyPage()
        {
            InitializeComponent();
            ...
            // BindingContext = new TearmsOfServicePrivacyPolicyPageViewModel();
        }
    }

    /*
    class TearmsOfServicePrivacyPolicyPageViewModel : INotifyPropertyChanged
    {

        public TearmsOfServicePrivacyPolicyPageViewModel()
        {
