...
namespace MdiChat.View
{
    ...
    public partial class EndUserLicenceAggreementPage : ContentPage
    {
        public EndUserLicenceAggreementPage()
        {
            InitializeComponent();
         ...
         //   BindingContext = new EndUserLicenceAggreementPageViewModel();
        }
    }

    /*
    class EndUserLicenceAggreementPageViewModel : INotifyPropertyChanged
    {

        public EndUserLicenceAggreementPageViewModel()
        {
